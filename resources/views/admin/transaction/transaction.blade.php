              ...
              data-created="{{ \Carbon\Carbon::parse($transaction->created_at)->timestamp }}">
                ...
                <td role="cell">
                  <div class="d-flex item-group">
                    ...
                    <button type="button" class="btn table-btn transaction-details-btn"
...
@once
  ...
  <link rel="stylesheet" href="{{ asset('css/admin/transaction/transaction.css') }}">
...
@once
  ...
  <script type="text/javascript" src="{{ asset('js/dashboard/modal/transactionDetails.js') }}" defer></script>
  @endpush
@endonce