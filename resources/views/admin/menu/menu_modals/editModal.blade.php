<div id="editModal" class="modal" style="display: none;">
    <div class="modal-dialog">
        <form id="editMenuForm" method="POST" class="modal-content" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="input-group">
                        ...
                        <input type="text" name="name" id="edit-name" placeholder="e.g., Bulalo" required>
                    </div>

                    <div class="input-group">
                        <label for="category">Category</label>
                        <select name="category_id" id="edit-category" class="unit-selector" placeholder="Select category..." required>
                    ...
                    <div class="branch-select-wrapper">
                        <div class="input-group">
                            ...
                            <select name="branch_ids[]" id="edit-dish_branches" placeholder="Select branches..." multiple required>
                ...
                <div class="tab-container">
                    <div class="row tab-titles mb-3">
                        <h3 class="tab-links active-link underline-fullwidth" onclick="openTab(event, 'edit-recipe')">Recipe & Costing</h3>
                        <h3 class="tab-links underline-fullwidth" onclick="openTab(event, 'edit-others')">Others</h3>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody id="edit-recipe-list">
                                <tr class="recipe-row">
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text" inputmode="decimal" pattern="[0-9]*(\.[0-9]+)?" name="ingredients[0][quantity_used]" class="recipe-qty" step="0.01" min="0" value="" required>
                            ...
                            <tfoot class="border-t">
                                <tr>
                                    ...
                                    <td>
                                        <span id="edit-sub-total-display">&#8369;0.00</span>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <div class="tab-contents active-tab" id="edit-recipe">
                        <div class="row">
                            <div class="input-group">
                                <span for="q-factor">Q-Factor (10%):</span>
                                <data id="edit-q-factor-display" class="format-peso">0.00</data>
                            </div>

                             <div class="input-group">
                                <span>Suggested Price:</span>
                                <data id="edit-suggested-price-display" class="format-peso">0.00</data>
                            </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="input-group">
                                ...
                                <input type="text" inputmode="decimal" pattern="[0-9]*(\.[0-9]+)?" name="margin" id="edit-margin" required value="30">
                            </div>

                            <div class="input-group">
                                <label for="final-price">Your Price</label>
                                <span class="icon-wrapper currency-symbol">&#8369;</span>
                                <input type="text" inputmode="decimal" pattern="[0-9]*(\.[0-9]+)?" name="final_price" id="edit-final-price" required>
                            </div>
                        </div>
                    </div>

                    <div id="edit-others" class="tab-contents">
                        <div class="row">
                            <div class="input-group">
                                <label for="description">Description</label>
                                <textarea name="description" id="edit-description" placeholder="Enter Description..."></textarea>
                            </div>
                        </div>
