...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/dashboard/sidebar.css') }}?v={{ time() }}">
...
<body>
  ...
  <script type="text/javascript" src="{{ asset('js/dashboard/sidebarToggles.js') }}?v={{ time() }}" defer></script>
</body>
</html>