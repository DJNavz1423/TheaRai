...
<body>
    ...
    <nav>
      <ul>
        ...
        <li class="{{ request()->routeIs('cashier.pos') ? 'active' : '' }}">
          ...
          <span class="nav-item">P.O.S</span>
          </a>
        </li>
        ...
        <li>
          ...
          {{-- dropdown settings --}}
        <li>
           <button onclick=toggleSubMenu(this) class="dropdown-btn sidebar-btn {{ request()->routeIs('settings.*') ? 'active' : '' }}">
            <span class="icon-wrapper">
  ...
  <main>
    <header id="header" class="border-b">
      <div>
        <button onclick=toggleSidebar() id="header-toggle-btn" class="sidebar-btn hidden-btn" style="position: relative;"> 
