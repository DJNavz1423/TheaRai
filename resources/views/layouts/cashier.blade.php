...
<body>
  ...
  <main>
    <header>
      <div>
        <button onclick=toggleSidebar() id="header-toggle-btn" class="sidebar-btn hidden-btn">
          ...
          <div class="searchbox">
            ...
            <input type="text" id="headerSearch" class="border searchBar" placeholder="Search products...">
        </div>
      </div>
