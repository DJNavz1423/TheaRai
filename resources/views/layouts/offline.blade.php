        ...
        <li class="{{ request()->routeIs('offline.pos') ? 'active' : '' }}">
          <a href="/offline-pos">
            <span class="icon-wrapper">
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3">
                <path d="M520-640v-160q0-17 11.5-28.5T560-840h240q17 0 28.5 11.5T840-800v160q0 40-40 40H560q-40 0-40-40ZM120-480v-320q0-17 11.5-28.5T160-840h240q17 0 28.5 11.5T440-800v320q0 40-40 40H160q-40 0-40-40Zm400 320v-320q0-17 11.5-28.5T560-520h240q17 0 28.5 11.5T840-480v320q0 40-40 40H560q-40 0-40-40Zm-400 0v-160q0-17 11.5-28.5T160-360h240q40 0 40 40v160q0 40-40 40H160q-40 0-40-40Z"/>
              </svg>
            </span>
